...
double hadronicTopSystemChiSquare::getHadronicChiSquare()
{
  ...
  double hadChi2=pow(WDaughter2PtDelta_,2)/pow(WDaughter2PtWidth_,2)+pow(WDaughter2PhiDelta_,2)/pow(WDaughter2PhiWidth_,2)+pow(WDaughter2EtaDelta_,2)/pow(WDaughter2EtaWidth_,2);
