...
leptonicTopSystemChiSquare::leptonicTopSystemChiSquare(
    ...
    const double &leptonPz, const double &leptonE, const double &leptonPtWidth,
    const double &leptonEtaWidth, const double &leptonPhiWidth,
    const double &mTop, const double &sigmaMTop, const double &mW,
    const double &sigmaMW)
    : topSystemChiSquare(bJetPx, bJetPy, bJetPz, bJetE, bJetPtWidth,
                         bJetEtaWidth, bJetPhiWidth, leptonPx, leptonPy,
                         leptonPz, leptonE, leptonPtWidth, leptonEtaWidth,
                         leptonPhiWidth, mTop, sigmaMTop, mW, sigmaMW, 0.),
      chi2_(0.)
{
...
{
    chi2_ = bJetPtDelta_ * bJetPtDelta_ + bJetPhiDelta_ * bJetPhiDelta_ +
            ...
            //    +breitWignerError(mTop_,sigmaMTop_,deltaMTop_)   //moved to
            //    inner minimization
