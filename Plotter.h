...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("./output_files/output_0.root");
      if (!f || !f->IsOpen()) {
...
void Plotter::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("innerMinStatus", &innerMinStatus, &b_innerMinStatus);
   fChain->SetBranchAddress("outerMinStatus", &outerMinStatus, &b_outerMinStatus);
   ...
   fChain->SetBranchAddress("W1Daughter1PtDelta", &W1Daughter1PtDelta, &b_W1Daughter1PtDelta);
   fChain->SetBranchAddress("W1Daughter1PhiDelta", &W1Daughter1PhiDelta, &b_W1Daughter1PhiDelta);
   fChain->SetBranchAddress("W1Daughter1EtaDelta", &W1Daughter1EtaDelta, &b_W1Daughter1EtaDelta);
   fChain->SetBranchAddress("W2Daughter1PtDelta", &W2Daughter1PtDelta, &b_W2Daughter1PtDelta);
   fChain->SetBranchAddress("W2Daughter1PhiDelta", &W2Daughter1PhiDelta, &b_W2Daughter1PhiDelta);
   fChain->SetBranchAddress("W2Daughter1EtaDelta", &W2Daughter1EtaDelta, &b_W2Daughter1EtaDelta);
   fChain->SetBranchAddress("W1Daughter2PtDelta", &W1Daughter2PtDelta, &b_W1Daughter2PtDelta);
   fChain->SetBranchAddress("W1Daughter2PhiDelta", &W1Daughter2PhiDelta, &b_W1Daughter2PhiDelta);
   fChain->SetBranchAddress("W1Daughter2EtaDelta", &W1Daughter2EtaDelta, &b_W1Daughter2EtaDelta);
   fChain->SetBranchAddress("W2Daughter2PtDelta", &W2Daughter2PtDelta, &b_W2Daughter2PtDelta);
   fChain->SetBranchAddress("W2Daughter2PhiDelta", &W2Daughter2PhiDelta, &b_W2Daughter2PhiDelta);
   fChain->SetBranchAddress("W2Daughter2EtaDelta", &W2Daughter2EtaDelta, &b_W2Daughter2EtaDelta);
   ...
   fChain->SetBranchAddress("lightJet1PxDelta", &lightJet1PxDelta, &b_lightJet1PxDelta);
   fChain->SetBranchAddress("lightJet1PyDelta", &lightJet1PyDelta, &b_lightJet1PyDelta);
   fChain->SetBranchAddress("lightJet2PxDelta", &lightJet2PxDelta, &b_lightJet2PxDelta);
   fChain->SetBranchAddress("lightJet2PyDelta", &lightJet2PyDelta, &b_lightJet2PyDelta);
   ...
   fChain->SetBranchAddress("W1Daughter1TruePt", &W1Daughter1TruePt, &b_W1Daughter1TruePt);
   fChain->SetBranchAddress("W1Daughter1TrueEta", &W1Daughter1TrueEta, &b_W1Daughter1TrueEta);
   fChain->SetBranchAddress("W1Daughter1TruePhi", &W1Daughter1TruePhi, &b_W1Daughter1TruePhi);
   fChain->SetBranchAddress("W1Daughter1TrueE", &W1Daughter1TrueE, &b_W1Daughter1TrueE);
   fChain->SetBranchAddress("W1Daughter2TruePt", &W1Daughter2TruePt, &b_W1Daughter2TruePt);
   fChain->SetBranchAddress("W1Daughter2TrueEta", &W1Daughter2TrueEta, &b_W1Daughter2TrueEta);
   fChain->SetBranchAddress("W1Daughter2TruePhi", &W1Daughter2TruePhi, &b_W1Daughter2TruePhi);
   fChain->SetBranchAddress("W1Daughter2TrueE", &W1Daughter2TrueE, &b_W1Daughter2TrueE);
   fChain->SetBranchAddress("lightJet1TruePx", &lightJet1TruePx, &b_lightJet1TruePx);
   fChain->SetBranchAddress("lightJet1TruePy", &lightJet1TruePy, &b_lightJet1TruePy);
   fChain->SetBranchAddress("lightJet1TruePz", &lightJet1TruePz, &b_lightJet1TruePz);
   fChain->SetBranchAddress("lightJet1TrueE", &lightJet1TrueE, &b_lightJet1TrueE);
   fChain->SetBranchAddress("lightJet1TruePt", &lightJet1TruePt, &b_lightJet1TruePt);
   ...
   fChain->SetBranchAddress("W2Daughter1TruePt", &W2Daughter1TruePt, &b_W2Daughter1TruePt);
   fChain->SetBranchAddress("W2Daughter1TrueEta", &W2Daughter1TrueEta, &b_W2Daughter1TrueEta);
   fChain->SetBranchAddress("W2Daughter1TruePhi", &W2Daughter1TruePhi, &b_W2Daughter1TruePhi);
   fChain->SetBranchAddress("W2Daughter1TrueE", &W2Daughter1TrueE, &b_W2Daughter1TrueE);
   fChain->SetBranchAddress("W2Daughter2TruePt", &W2Daughter2TruePt, &b_W2Daughter2TruePt);
   fChain->SetBranchAddress("W2Daughter2TrueEta", &W2Daughter2TrueEta, &b_W2Daughter2TrueEta);
   fChain->SetBranchAddress("W2Daughter2TruePhi", &W2Daughter2TruePhi, &b_W2Daughter2TruePhi);
   fChain->SetBranchAddress("W2Daughter2TrueE", &W2Daughter2TrueE, &b_W2Daughter2TrueE);
   fChain->SetBranchAddress("lightJet2TruePx", &lightJet2TruePx, &b_lightJet2TruePx);
   fChain->SetBranchAddress("lightJet2TruePy", &lightJet2TruePy, &b_lightJet2TruePy);
   fChain->SetBranchAddress("lightJet2TruePz", &lightJet2TruePz, &b_lightJet2TruePz);
   fChain->SetBranchAddress("lightJet2TrueE", &lightJet2TrueE, &b_lightJet2TrueE);
   fChain->SetBranchAddress("lightJet2TruePt", &lightJet2TruePt, &b_lightJet2TruePt);
   fChain->SetBranchAddress("top1SmearedPt", &top1SmearedPt, &b_top1SmearedPt);
   fChain->SetBranchAddress("top1SmearedEta", &top1SmearedEta, &b_top1SmearedEta);
   fChain->SetBranchAddress("top1SmearedPhi", &top1SmearedPhi, &b_top1SmearedPhi);
   fChain->SetBranchAddress("top1SmearedE", &top1SmearedE, &b_top1SmearedE);
   fChain->SetBranchAddress("top1SmearedMass", &top1SmearedMass, &b_top1SmearedMass);
   ...
   fChain->SetBranchAddress("bJet1SmearedPt", &bJet1SmearedPt, &b_bJet1SmearedPt);
   fChain->SetBranchAddress("bJet1SmearedEta", &bJet1SmearedEta, &b_bJet1SmearedEta);
   fChain->SetBranchAddress("bJet1SmearedPhi", &bJet1SmearedPhi, &b_bJet1SmearedPhi);
   fChain->SetBranchAddress("bJet1SmearedE", &bJet1SmearedE, &b_bJet1SmearedE);
   fChain->SetBranchAddress("W1Daughter1SmearedPt", &W1Daughter1SmearedPt, &b_W1Daughter1SmearedPt);
   fChain->SetBranchAddress("W1Daughter1SmearedEta", &W1Daughter1SmearedEta, &b_W1Daughter1SmearedEta);
   fChain->SetBranchAddress("W1Daughter1SmearedPhi", &W1Daughter1SmearedPhi, &b_W1Daughter1SmearedPhi);
   fChain->SetBranchAddress("W1Daughter1SmearedE", &W1Daughter1SmearedE, &b_W1Daughter1SmearedE);
   fChain->SetBranchAddress("W1Daughter2SmearedPt", &W1Daughter2SmearedPt, &b_W1Daughter2SmearedPt);
   fChain->SetBranchAddress("W1Daughter2SmearedEta", &W1Daughter2SmearedEta, &b_W1Daughter2SmearedEta);
   fChain->SetBranchAddress("W1Daughter2SmearedPhi", &W1Daughter2SmearedPhi, &b_W1Daughter2SmearedPhi);
   fChain->SetBranchAddress("W1Daughter2SmearedE", &W1Daughter2SmearedE, &b_W1Daughter2SmearedE);
   fChain->SetBranchAddress("lightJet1SmearedPx", &lightJet1SmearedPx, &b_lightJet1SmearedPx);
   fChain->SetBranchAddress("lightJet1SmearedPy", &lightJet1SmearedPy, &b_lightJet1SmearedPy);
   fChain->SetBranchAddress("lightJet1SmearedPz", &lightJet1SmearedPz, &b_lightJet1SmearedPz);
   fChain->SetBranchAddress("lightJet1SmearedE", &lightJet1SmearedE, &b_lightJet1SmearedE);
   fChain->SetBranchAddress("lightJet1SmearedPt", &lightJet1SmearedPt, &b_lightJet1SmearedPt);
   fChain->SetBranchAddress("top2SmearedPt", &top2SmearedPt, &b_top2SmearedPt);
   fChain->SetBranchAddress("top2SmearedEta", &top2SmearedEta, &b_top2SmearedEta);
   fChain->SetBranchAddress("top2SmearedPhi", &top2SmearedPhi, &b_top2SmearedPhi);
   fChain->SetBranchAddress("top2SmearedE", &top2SmearedE, &b_top2SmearedE);
   fChain->SetBranchAddress("top2SmearedMass", &top2SmearedMass, &b_top2SmearedMass);
   ...
   fChain->SetBranchAddress("bJet2SmearedPt", &bJet2SmearedPt, &b_bJet2SmearedPt);
   fChain->SetBranchAddress("bJet2SmearedEta", &bJet2SmearedEta, &b_bJet2SmearedEta);
   fChain->SetBranchAddress("bJet2SmearedPhi", &bJet2SmearedPhi, &b_bJet2SmearedPhi);
   fChain->SetBranchAddress("bJet2SmearedE", &bJet2SmearedE, &b_bJet2SmearedE);
   fChain->SetBranchAddress("W2Daughter1SmearedPt", &W2Daughter1SmearedPt, &b_W2Daughter1SmearedPt);
   fChain->SetBranchAddress("W2Daughter1SmearedEta", &W2Daughter1SmearedEta, &b_W2Daughter1SmearedEta);
   fChain->SetBranchAddress("W2Daughter1SmearedPhi", &W2Daughter1SmearedPhi, &b_W2Daughter1SmearedPhi);
   fChain->SetBranchAddress("W2Daughter1SmearedE", &W2Daughter1SmearedE, &b_W2Daughter1SmearedE);
   fChain->SetBranchAddress("W2Daughter2SmearedPt", &W2Daughter2SmearedPt, &b_W2Daughter2SmearedPt);
   fChain->SetBranchAddress("W2Daughter2SmearedEta", &W2Daughter2SmearedEta, &b_W2Daughter2SmearedEta);
   fChain->SetBranchAddress("W2Daughter2SmearedPhi", &W2Daughter2SmearedPhi, &b_W2Daughter2SmearedPhi);
   fChain->SetBranchAddress("W2Daughter2SmearedE", &W2Daughter2SmearedE, &b_W2Daughter2SmearedE);
   fChain->SetBranchAddress("lightJet2SmearedPx", &lightJet2SmearedPx, &b_lightJet2SmearedPx);
   fChain->SetBranchAddress("lightJet2SmearedPy", &lightJet2SmearedPy, &b_lightJet2SmearedPy);
   fChain->SetBranchAddress("lightJet2SmearedPz", &lightJet2SmearedPz, &b_lightJet2SmearedPz);
   fChain->SetBranchAddress("lightJet2SmearedE", &lightJet2SmearedE, &b_lightJet2SmearedE);
   fChain->SetBranchAddress("lightJet2SmearedPt", &lightJet2SmearedPt, &b_lightJet2SmearedPt);
   ...
   fChain->SetBranchAddress("W1Daughter1BestPt", &W1Daughter1BestPt, &b_W1Daughter1BestPt);
   fChain->SetBranchAddress("W1Daughter1BestEta", &W1Daughter1BestEta, &b_W1Daughter1BestEta);
   fChain->SetBranchAddress("W1Daughter1BestPhi", &W1Daughter1BestPhi, &b_W1Daughter1BestPhi);
   fChain->SetBranchAddress("W1Daughter1BestE", &W1Daughter1BestE, &b_W1Daughter1BestE);
   fChain->SetBranchAddress("W1Daughter2BestPt", &W1Daughter2BestPt, &b_W1Daughter2BestPt);
   fChain->SetBranchAddress("W1Daughter2BestEta", &W1Daughter2BestEta, &b_W1Daughter2BestEta);
   fChain->SetBranchAddress("W1Daughter2BestPhi", &W1Daughter2BestPhi, &b_W1Daughter2BestPhi);
   fChain->SetBranchAddress("W1Daughter2BestE", &W1Daughter2BestE, &b_W1Daughter2BestE);
   fChain->SetBranchAddress("lightJet1BestPx", &lightJet1BestPx, &b_lightJet1BestPx);
   fChain->SetBranchAddress("lightJet1BestPy", &lightJet1BestPy, &b_lightJet1BestPy);
   fChain->SetBranchAddress("lightJet1BestPz", &lightJet1BestPz, &b_lightJet1BestPz);
   fChain->SetBranchAddress("lightJet1BestE", &lightJet1BestE, &b_lightJet1BestE);
   fChain->SetBranchAddress("lightJet1BestPt", &lightJet1BestPt, &b_lightJet1BestPt);
   ...
   fChain->SetBranchAddress("W2Daughter1BestPt", &W2Daughter1BestPt, &b_W2Daughter1BestPt);
   fChain->SetBranchAddress("W2Daughter1BestEta", &W2Daughter1BestEta, &b_W2Daughter1BestEta);
   fChain->SetBranchAddress("W2Daughter1BestPhi", &W2Daughter1BestPhi, &b_W2Daughter1BestPhi);
   fChain->SetBranchAddress("W2Daughter1BestE", &W2Daughter1BestE, &b_W2Daughter1BestE);
   fChain->SetBranchAddress("W2Daughter2BestPt", &W2Daughter2BestPt, &b_W2Daughter2BestPt);
   fChain->SetBranchAddress("W2Daughter2BestEta", &W2Daughter2BestEta, &b_W2Daughter2BestEta);
   fChain->SetBranchAddress("W2Daughter2BestPhi", &W2Daughter2BestPhi, &b_W2Daughter2BestPhi);
   fChain->SetBranchAddress("W2Daughter2BestE", &W2Daughter2BestE, &b_W2Daughter2BestE);
   fChain->SetBranchAddress("lightJet2BestPx", &lightJet2BestPx, &b_lightJet2BestPx);
   fChain->SetBranchAddress("lightJet2BestPy", &lightJet2BestPy, &b_lightJet2BestPy);
   fChain->SetBranchAddress("lightJet2BestPz", &lightJet2BestPz, &b_lightJet2BestPz);
   fChain->SetBranchAddress("lightJet2BestE", &lightJet2BestE, &b_lightJet2BestE);
   fChain->SetBranchAddress("lightJet2BestPt", &lightJet2BestPt, &b_lightJet2BestPt);
   fChain->SetBranchAddress("top1DeltaPtTrueSmeared", &top1DeltaPtTrueSmeared, &b_top1DeltaPtTrueSmeared);
   fChain->SetBranchAddress("top1DeltaRTrueSmeared", &top1DeltaRTrueSmeared, &b_top1DeltaRTrueSmeared);
   fChain->SetBranchAddress("top1DeltaMTrueSmeared", &top1DeltaMTrueSmeared, &b_top1DeltaMTrueSmeared);
   fChain->SetBranchAddress("W1DeltaPtTrueSmeared", &W1DeltaPtTrueSmeared, &b_W1DeltaPtTrueSmeared);
   fChain->SetBranchAddress("W1DeltaRTrueSmeared", &W1DeltaRTrueSmeared, &b_W1DeltaRTrueSmeared);
   fChain->SetBranchAddress("W1DeltaMTrueSmeared", &W1DeltaMTrueSmeared, &b_W1DeltaMTrueSmeared);
   fChain->SetBranchAddress("bJet1DeltaPtTrueSmeared", &bJet1DeltaPtTrueSmeared, &b_bJet1DeltaPtTrueSmeared);
   fChain->SetBranchAddress("bJet1DeltaRTrueSmeared", &bJet1DeltaRTrueSmeared, &b_bJet1DeltaRTrueSmeared);
   fChain->SetBranchAddress("W1Daughter1DeltaPtTrueSmeared", &W1Daughter1DeltaPtTrueSmeared, &b_W1Daughter1DeltaPtTrueSmeared);
   fChain->SetBranchAddress("W1Daughter1DeltaRTrueSmeared", &W1Daughter1DeltaRTrueSmeared, &b_W1Daughter1DeltaRTrueSmeared);
   fChain->SetBranchAddress("W1Daughter2DeltaPtTrueSmeared", &W1Daughter2DeltaPtTrueSmeared, &b_W1Daughter2DeltaPtTrueSmeared);
   fChain->SetBranchAddress("W1Daughter2DeltaRTrueSmeared", &W1Daughter2DeltaRTrueSmeared, &b_W1Daughter2DeltaRTrueSmeared);
   fChain->SetBranchAddress("lightJet1DeltaPxTrueSmeared", &lightJet1DeltaPxTrueSmeared, &b_lightJet1DeltaPxTrueSmeared);
   fChain->SetBranchAddress("lightJet1DeltaPyTrueSmeared", &lightJet1DeltaPyTrueSmeared, &b_lightJet1DeltaPyTrueSmeared);
   fChain->SetBranchAddress("lightJet1DeltaRTrueSmeared", &lightJet1DeltaRTrueSmeared, &b_lightJet1DeltaRTrueSmeared);
   fChain->SetBranchAddress("top2DeltaPtTrueSmeared", &top2DeltaPtTrueSmeared, &b_top2DeltaPtTrueSmeared);
   fChain->SetBranchAddress("top2DeltaRTrueSmeared", &top2DeltaRTrueSmeared, &b_top2DeltaRTrueSmeared);
   fChain->SetBranchAddress("top2DeltaMTrueSmeared", &top2DeltaMTrueSmeared, &b_top2DeltaMTrueSmeared);
   fChain->SetBranchAddress("W2DeltaPtTrueSmeared", &W2DeltaPtTrueSmeared, &b_W2DeltaPtTrueSmeared);
   fChain->SetBranchAddress("W2DeltaRTrueSmeared", &W2DeltaRTrueSmeared, &b_W2DeltaRTrueSmeared);
   fChain->SetBranchAddress("W2DeltaMTrueSmeared", &W2DeltaMTrueSmeared, &b_W2DeltaMTrueSmeared);
   fChain->SetBranchAddress("bJet2DeltaPtTrueSmeared", &bJet2DeltaPtTrueSmeared, &b_bJet2DeltaPtTrueSmeared);
   fChain->SetBranchAddress("bJet2DeltaRTrueSmeared", &bJet2DeltaRTrueSmeared, &b_bJet2DeltaRTrueSmeared);
   fChain->SetBranchAddress("W2Daughter1DeltaPtTrueSmeared", &W2Daughter1DeltaPtTrueSmeared, &b_W2Daughter1DeltaPtTrueSmeared);
   fChain->SetBranchAddress("W2Daughter1DeltaRTrueSmeared", &W2Daughter1DeltaRTrueSmeared, &b_W2Daughter1DeltaRTrueSmeared);
   fChain->SetBranchAddress("W2Daughter2DeltaPtTrueSmeared", &W2Daughter2DeltaPtTrueSmeared, &b_W2Daughter2DeltaPtTrueSmeared);
   fChain->SetBranchAddress("W2Daughter2DeltaRTrueSmeared", &W2Daughter2DeltaRTrueSmeared, &b_W2Daughter2DeltaRTrueSmeared);
   fChain->SetBranchAddress("lightJet2DeltaPxTrueSmeared", &lightJet2DeltaPxTrueSmeared, &b_lightJet2DeltaPxTrueSmeared);
   fChain->SetBranchAddress("lightJet2DeltaPyTrueSmeared", &lightJet2DeltaPyTrueSmeared, &b_lightJet2DeltaPyTrueSmeared);
   fChain->SetBranchAddress("lightJet2DeltaRTrueSmeared", &lightJet2DeltaRTrueSmeared, &b_lightJet2DeltaRTrueSmeared);
   fChain->SetBranchAddress("top1DeltaPtTrueBest", &top1DeltaPtTrueBest, &b_top1DeltaPtTrueBest);
   fChain->SetBranchAddress("top1DeltaRTrueBest", &top1DeltaRTrueBest, &b_top1DeltaRTrueBest);
   fChain->SetBranchAddress("top1DeltaMTrueBest", &top1DeltaMTrueBest, &b_top1DeltaMTrueBest);
   fChain->SetBranchAddress("W1DeltaPtTrueBest", &W1DeltaPtTrueBest, &b_W1DeltaPtTrueBest);
   fChain->SetBranchAddress("W1DeltaRTrueBest", &W1DeltaRTrueBest, &b_W1DeltaRTrueBest);
   fChain->SetBranchAddress("W1DeltaMTrueBest", &W1DeltaMTrueBest, &b_W1DeltaMTrueBest);
   fChain->SetBranchAddress("bJet1DeltaPtTrueBest", &bJet1DeltaPtTrueBest, &b_bJet1DeltaPtTrueBest);
   fChain->SetBranchAddress("bJet1DeltaRTrueBest", &bJet1DeltaRTrueBest, &b_bJet1DeltaRTrueBest);
   fChain->SetBranchAddress("W1Daughter1DeltaPtTrueBest", &W1Daughter1DeltaPtTrueBest, &b_W1Daughter1DeltaPtTrueBest);
   fChain->SetBranchAddress("W1Daughter1DeltaRTrueBest", &W1Daughter1DeltaRTrueBest, &b_W1Daughter1DeltaRTrueBest);
   fChain->SetBranchAddress("W1Daughter2DeltaPtTrueBest", &W1Daughter2DeltaPtTrueBest, &b_W1Daughter2DeltaPtTrueBest);
   fChain->SetBranchAddress("W1Daughter2DeltaRTrueBest", &W1Daughter2DeltaRTrueBest, &b_W1Daughter2DeltaRTrueBest);
   fChain->SetBranchAddress("lightJet1DeltaPxTrueBest", &lightJet1DeltaPxTrueBest, &b_lightJet1DeltaPxTrueBest);
   fChain->SetBranchAddress("lightJet1DeltaPyTrueBest", &lightJet1DeltaPyTrueBest, &b_lightJet1DeltaPyTrueBest);
   fChain->SetBranchAddress("lightJet1DeltaRTrueBest", &lightJet1DeltaRTrueBest, &b_lightJet1DeltaRTrueBest);
   fChain->SetBranchAddress("top2DeltaPtTrueBest", &top2DeltaPtTrueBest, &b_top2DeltaPtTrueBest);
   fChain->SetBranchAddress("top2DeltaRTrueBest", &top2DeltaRTrueBest, &b_top2DeltaRTrueBest);
   fChain->SetBranchAddress("top2DeltaMTrueBest", &top2DeltaMTrueBest, &b_top2DeltaMTrueBest);
   fChain->SetBranchAddress("W2DeltaPtTrueBest", &W2DeltaPtTrueBest, &b_W2DeltaPtTrueBest);
   fChain->SetBranchAddress("W2DeltaRTrueBest", &W2DeltaRTrueBest, &b_W2DeltaRTrueBest);
   fChain->SetBranchAddress("W2DeltaMTrueBest", &W2DeltaMTrueBest, &b_W2DeltaMTrueBest);
   fChain->SetBranchAddress("bJet2DeltaPtTrueBest", &bJet2DeltaPtTrueBest, &b_bJet2DeltaPtTrueBest);
   fChain->SetBranchAddress("bJet2DeltaRTrueBest", &bJet2DeltaRTrueBest, &b_bJet2DeltaRTrueBest);
   fChain->SetBranchAddress("W2Daughter1DeltaPtTrueBest", &W2Daughter1DeltaPtTrueBest, &b_W2Daughter1DeltaPtTrueBest);
   fChain->SetBranchAddress("W2Daughter1DeltaRTrueBest", &W2Daughter1DeltaRTrueBest, &b_W2Daughter1DeltaRTrueBest);
   fChain->SetBranchAddress("W2Daughter2DeltaPtTrueBest", &W2Daughter2DeltaPtTrueBest, &b_W2Daughter2DeltaPtTrueBest);
   fChain->SetBranchAddress("W2Daughter2DeltaRTrueBest", &W2Daughter2DeltaRTrueBest, &b_W2Daughter2DeltaRTrueBest);
   fChain->SetBranchAddress("lightJet2DeltaPxTrueBest", &lightJet2DeltaPxTrueBest, &b_lightJet2DeltaPxTrueBest);
   fChain->SetBranchAddress("lightJet2DeltaPyTrueBest", &lightJet2DeltaPyTrueBest, &b_lightJet2DeltaPyTrueBest);
   fChain->SetBranchAddress("lightJet2DeltaRTrueBest", &lightJet2DeltaRTrueBest, &b_lightJet2DeltaRTrueBest);
   fChain->SetBranchAddress("top1DeltaPtSmearedBest", &top1DeltaPtSmearedBest, &b_top1DeltaPtSmearedBest);
   fChain->SetBranchAddress("top1DeltaRSmearedBest", &top1DeltaRSmearedBest, &b_top1DeltaRSmearedBest);
   fChain->SetBranchAddress("top1DeltaMSmearedBest", &top1DeltaMSmearedBest, &b_top1DeltaMSmearedBest);
   fChain->SetBranchAddress("W1DeltaPtSmearedBest", &W1DeltaPtSmearedBest, &b_W1DeltaPtSmearedBest);
   fChain->SetBranchAddress("W1DeltaRSmearedBest", &W1DeltaRSmearedBest, &b_W1DeltaRSmearedBest);
   fChain->SetBranchAddress("W1DeltaMSmearedBest", &W1DeltaMSmearedBest, &b_W1DeltaMSmearedBest);
   fChain->SetBranchAddress("bJet1DeltaPtSmearedBest", &bJet1DeltaPtSmearedBest, &b_bJet1DeltaPtSmearedBest);
   fChain->SetBranchAddress("bJet1DeltaRSmearedBest", &bJet1DeltaRSmearedBest, &b_bJet1DeltaRSmearedBest);
   fChain->SetBranchAddress("bJet1DeltaMSmearedBest", &bJet1DeltaMSmearedBest, &b_bJet1DeltaMSmearedBest);
   fChain->SetBranchAddress("W1Daughter1DeltaPtSmearedBest", &W1Daughter1DeltaPtSmearedBest, &b_W1Daughter1DeltaPtSmearedBest);
   fChain->SetBranchAddress("W1Daughter1DeltaRSmearedBest", &W1Daughter1DeltaRSmearedBest, &b_W1Daughter1DeltaRSmearedBest);
   fChain->SetBranchAddress("W1Daughter1DeltaMSmearedBest", &W1Daughter1DeltaMSmearedBest, &b_W1Daughter1DeltaMSmearedBest);
   fChain->SetBranchAddress("W1Daughter2DeltaPtSmearedBest", &W1Daughter2DeltaPtSmearedBest, &b_W1Daughter2DeltaPtSmearedBest);
   fChain->SetBranchAddress("W1Daughter2DeltaRSmearedBest", &W1Daughter2DeltaRSmearedBest, &b_W1Daughter2DeltaRSmearedBest);
   fChain->SetBranchAddress("W1Daughter2DeltaMSmearedBest", &W1Daughter2DeltaMSmearedBest, &b_W1Daughter2DeltaMSmearedBest);
   fChain->SetBranchAddress("lightJet1DeltaPxSmearedBest", &lightJet1DeltaPxSmearedBest, &b_lightJet1DeltaPxSmearedBest);
   fChain->SetBranchAddress("lightJet1DeltaPySmearedBest", &lightJet1DeltaPySmearedBest, &b_lightJet1DeltaPySmearedBest);
   fChain->SetBranchAddress("lightJet1DeltaRSmearedBest", &lightJet1DeltaRSmearedBest, &b_lightJet1DeltaRSmearedBest);
   fChain->SetBranchAddress("top2DeltaPtSmearedBest", &top2DeltaPtSmearedBest, &b_top2DeltaPtSmearedBest);
   fChain->SetBranchAddress("top2DeltaRSmearedBest", &top2DeltaRSmearedBest, &b_top2DeltaRSmearedBest);
   fChain->SetBranchAddress("top2DeltaMSmearedBest", &top2DeltaMSmearedBest, &b_top2DeltaMSmearedBest);
   fChain->SetBranchAddress("W2DeltaPtSmearedBest", &W2DeltaPtSmearedBest, &b_W2DeltaPtSmearedBest);
   fChain->SetBranchAddress("W2DeltaRSmearedBest", &W2DeltaRSmearedBest, &b_W2DeltaRSmearedBest);
   fChain->SetBranchAddress("W2DeltaMSmearedBest", &W2DeltaMSmearedBest, &b_W2DeltaMSmearedBest);
   fChain->SetBranchAddress("bJet2DeltaPtSmearedBest", &bJet2DeltaPtSmearedBest, &b_bJet2DeltaPtSmearedBest);
   fChain->SetBranchAddress("bJet2DeltaRSmearedBest", &bJet2DeltaRSmearedBest, &b_bJet2DeltaRSmearedBest);
   fChain->SetBranchAddress("bJet2DeltaMSmearedBest", &bJet2DeltaMSmearedBest, &b_bJet2DeltaMSmearedBest);
   fChain->SetBranchAddress("W2Daughter1DeltaPtSmearedBest", &W2Daughter1DeltaPtSmearedBest, &b_W2Daughter1DeltaPtSmearedBest);
   fChain->SetBranchAddress("W2Daughter1DeltaRSmearedBest", &W2Daughter1DeltaRSmearedBest, &b_W2Daughter1DeltaRSmearedBest);
   fChain->SetBranchAddress("W2Daughter1DeltaMSmearedBest", &W2Daughter1DeltaMSmearedBest, &b_W2Daughter1DeltaMSmearedBest);
   fChain->SetBranchAddress("W2Daughter2DeltaPtSmearedBest", &W2Daughter2DeltaPtSmearedBest, &b_W2Daughter2DeltaPtSmearedBest);
   fChain->SetBranchAddress("W2Daughter2DeltaRSmearedBest", &W2Daughter2DeltaRSmearedBest, &b_W2Daughter2DeltaRSmearedBest);
   fChain->SetBranchAddress("W2Daughter2DeltaMSmearedBest", &W2Daughter2DeltaMSmearedBest, &b_W2Daughter2DeltaMSmearedBest);
   fChain->SetBranchAddress("lightJet2DeltaPxSmearedBest", &lightJet2DeltaPxSmearedBest, &b_lightJet2DeltaPxSmearedBest);
   fChain->SetBranchAddress("lightJet2DeltaPySmearedBest", &lightJet2DeltaPySmearedBest, &b_lightJet2DeltaPySmearedBest);
   fChain->SetBranchAddress("lightJet2DeltaRSmearedBest", &lightJet2DeltaRSmearedBest, &b_lightJet2DeltaRSmearedBest);
   Notify();
}
