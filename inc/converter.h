...
// Tue Nov 10 14:06:32 2015 by ROOT version 6.02/05
// from TTree LHEF/Analysis tree
// found on file: singlemu_onshell2_6nov.root
//////////////////////////////////////////////////////////
...
class converter
{
  public:
    ...
    static const Int_t kMaxParticle = 15;
    ...
    int run, event, status, n_particles;
    double lumi;
...
converter::converter(TTree *tree) : fChain(0)
{
    ...
    if (tree == 0) {
        TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject(
            "singlemu_onshell2_6nov.root");
        if (!f || !f->IsOpen()) {
            f = new TFile("singlemu_onshell2_6nov.root");
        }
...
void converter::Init(TTree *tree)
{
    ...
    fChain->SetBranchAddress("Event.Nparticles", Event_Nparticles,
                             &b_Event_Nparticles);
    ...
    fChain->SetBranchAddress("Event.ScalePDF", Event_ScalePDF,
                             &b_Event_ScalePDF);
    fChain->SetBranchAddress("Event.CouplingQED", Event_CouplingQED,
                             &b_Event_CouplingQED);
    fChain->SetBranchAddress("Event.CouplingQCD", Event_CouplingQCD,
                             &b_Event_CouplingQCD);
    fChain->SetBranchAddress("Event_size", &Event_size, &b_Event_size);
    fChain->SetBranchAddress("Rwgt", &Rwgt_, &b_Rwgt_);
    fChain->SetBranchAddress("Rwgt.fUniqueID", &Rwgt_fUniqueID,
                             &b_Rwgt_fUniqueID);
    ...
    fChain->SetBranchAddress("Particle.Status", Particle_Status,
                             &b_Particle_Status);
    fChain->SetBranchAddress("Particle.Mother1", Particle_Mother1,
                             &b_Particle_Mother1);
    fChain->SetBranchAddress("Particle.Mother2", Particle_Mother2,
                             &b_Particle_Mother2);
    fChain->SetBranchAddress("Particle.ColorLine1", Particle_ColorLine1,
                             &b_Particle_ColorLine1);
    fChain->SetBranchAddress("Particle.ColorLine2", Particle_ColorLine2,
                             &b_Particle_ColorLine2);
    ...
    fChain->SetBranchAddress("Particle.Rapidity", Particle_Rapidity,
                             &b_Particle_Rapidity);
    fChain->SetBranchAddress("Particle.LifeTime", Particle_LifeTime,
                             &b_Particle_LifeTime);
