    ...
    for (Long64_t jentry = 0; jentry < nentries; jentry++) {
        ...
        for (int ivec = 0; ivec < numpar; ivec++) {
            if (Pid.at(ivec) == 5) {
                ...
                if (mother1.at(ivec) >= 0 and mother1.at(ivec) < numpar and
                    mother2.at(ivec) >= 0 and mother2.at(ivec) < numpar) {
                    if (Pid.at(mother1.at(ivec)) == 24 or
                        Pid.at(mother2.at(ivec)) == 24 or
                        Pid.at(mother1.at(ivec)) == -24 or
                        Pid.at(mother2.at(ivec)) == -24) {
                        Filler(10, ivec);
                        counter++;
                        // cout<<"pid6"<<endl;
                ...
                if (mother1.at(ivec) >= 0 and mother1.at(ivec) < numpar and
                    ...
                    if (Pid.at(mother1.at(ivec)) == 24 or
                        ...
                        counter++;
                        // cout<<"pid7"<<endl;
                        qbarFromW.SetPxPyPzE(Px.at(ivec), Py.at(ivec),
                                             Pz.at(ivec), En.at(ivec));
