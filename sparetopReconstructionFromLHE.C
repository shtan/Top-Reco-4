...
// int main()
{
    ...
    */
    ...
    int jStart = whichLoop * (nentries / maxLoops) +
                 ((whichLoop > (maxLoops - nentries % maxLoops))
                      ? (whichLoop + nentries % maxLoops - maxLoops)
                      : 0);
    // int jStart = 17;
    ...
    for (Long64_t jentry = jStart; jentry < jFinish; jentry++) {
        ...
        XYZTLorentzVector recoTopQuark(0, 0, 0, 0),
            recoAntiTopQuark(0, 0, 0, 0);
        ...
        XYZTLorentzVector smearedLightParton1, smearedLightParton2,
            smearedLepton, smearedAntiLepton;
        XYZTLorentzVector smearedOtherLightParton;
        std::vector<XYZTLorentzVector> smearedOtherLightPartons;
        bool leptonFlag = 0; // 1 if lepton and antineutrino (i.e. tbar branch
                             // is the leptonic one), 0 otherwise.

        double METx(0.), METy(0.);
        int iJet = 0;
        //      for(int iParticle = 0 ; iParticle < n_particles; iParticle++)
        //	{
        smearedLightQuark1.SetPxPyPzE(P_X->at(3), P_Y->at(3), P_Z->at(3),
                                      E->at(3));
        smearedLightQuark2.SetPxPyPzE(P_X->at(4), P_Y->at(4), P_Z->at(4),
                                      E->at(4));
        smearedBottomQuark.SetPxPyPzE(P_X->at(1), P_Y->at(1), P_Z->at(1),
                                      E->at(1));
        smearedAntiBottomQuark.SetPxPyPzE(P_X->at(2), P_Y->at(2), P_Z->at(2),
                                          E->at(2));
        smearedLightParton1.SetPxPyPzE(P_X->at(5), P_Y->at(5), P_Z->at(5),
                                       E->at(5));
        smearedLightParton2.SetPxPyPzE(P_X->at(6), P_Y->at(6), P_Z->at(6),
                                       E->at(6));
        // smearedLepton.SetPxPyPzE(P_X->at(0),P_Y->at(0),P_Z->at(0),E->at(0));

        topQuark.SetPxPyPzE(P_X->at(14), P_Y->at(14), P_Z->at(14), E->at(14));
        antiTopQuark.SetPxPyPzE(P_X->at(15), P_Y->at(15), P_Z->at(15),
                                E->at(15));
        ...
        antiBottomQuark.SetPxPyPzE(P_X->at(9), P_Y->at(9), P_Z->at(9),
                                   E->at(9));
        qFromW.SetPxPyPzE(P_X->at(10), P_Y->at(10), P_Z->at(10), E->at(10));
        qbarFromW.SetPxPyPzE(P_X->at(11), P_Y->at(11), P_Z->at(11), E->at(11));
        lightParton1.SetPxPyPzE(P_X->at(12), P_Y->at(12), P_Z->at(12),
                                E->at(12));
        lightParton2.SetPxPyPzE(P_X->at(13), P_Y->at(13), P_Z->at(13),
                                E->at(13));
        ...
        if (PID->at(0) == 13) {
            smearedLepton.SetPxPyPzE(P_X->at(0), P_Y->at(0), P_Z->at(0),
                                     E->at(0));
            lepton.SetPxPyPzE(P_X->at(7), P_Y->at(7), P_Z->at(7), E->at(7));
            antiNeutrino.SetPxPyPzE(P_X->at(18), P_Y->at(18), P_Z->at(18),
                                    E->at(18));
            leptonFlag = 1;
            leptonToAdd = smearedLepton;
        } else if (PID->at(0) == -13) {
            smearedAntiLepton.SetPxPyPzE(P_X->at(0), P_Y->at(0), P_Z->at(0),
                                         E->at(0));
            antiLepton.SetPxPyPzE(P_X->at(7), P_Y->at(7), P_Z->at(7), E->at(7));
            neutrino.SetPxPyPzE(P_X->at(18), P_Y->at(18), P_Z->at(18),
                                E->at(18));
            leptonFlag = 0;
            leptonToAdd = smearedAntiLepton;
        }

        XYZTLorentzVector allVisible =
            smearedLightQuark1 + smearedLightQuark2 + smearedBottomQuark +
            smearedAntiBottomQuark + smearedLightParton1 + smearedLightParton2 +
            leptonToAdd + allExternal;
        ...
        // hack-test to form an extra particle to absorb the discrepancy between
        // met and sum of all visible particles
        XYZTLorentzVector extraParticle;
        extraParticle.SetPxPyPzE(-allVisible.Px() - met.Px(),
                                 -allVisible.Py() - met.Py(), 0,
                                 pow((allVisible.Px() + met.Px()), 2) +
                                     pow((allVisible.Py() + met.Py()), 2));
        ...
        */
        /*      double bJet1PtSmear = log(1.+0.1)*rand.Gaus();
              ...
              //smear the lepton and anti-neutrino as if they were jets, to
           simulate the \bar{t} quark decaying hadronically
        ...
        */
        ...
        std::cout << "SIZEEEEEEEEEEEEEEEEEEEEEEE = " << nonTopObjects.size()
                  << std::endl;
        ...
        // cout << "b quark        mass is      " << smearedBottomQuark.M() <<
        // endl;
        ...
        // printVector(lepton);
        // cout << "smeared   1st light quark mass is " <<
        // smearedLightQuark1.M() << endl;
        // printVector(smearedLightQuark1);
        // cout << "smeared   2nd light quark mass is " <<
        // smearedLightQuark2.M() << endl;
        // printVector(smearedLightQuark2);
        // cout << "reco W-        mass is      " << recoWMinus.M() << endl;
        // printVector(recoWMinus);
        // cout << "b-bar quark    mass is      " << smearedAntiBottomQuark.M()
        // << endl;
        // printVector(smearedAntiBottomQuark);
        // cout << "reco anti top quark mass is " << recoAntiTopQuark.M() <<
        // endl;
        // printVector(recoAntiTopQuark);
        // cout << "first light parton  mass is " << smearedLightParton1.M() <<
        // endl;
        // printVector(smearedLightParton1);
        // cout << "second light parton mass is " << smearedLightParton2.M() <<
        // endl;
        ...
        if (leptonFlag == 0) {
            ev.addLeptonicTop(bJet1Px, bJet1Py, bJet1Pz, bJet1E,
                              ...
                              antiLeptonPx, antiLeptonPy, antiLeptonPz,
                              antiLeptonE, sigmaPtLep, sigmaEtaLep, sigmaPhiLep,
                              mTop, sigmaMTop, mW, sigmaMW);

            ev.addHadronicTop(bJet2Px, bJet2Py, bJet2Pz, bJet2E, sqrt(bJet2Pt),
                              sigmaEtaJet, sigmaPhiJet,
                              // sigmaPtJet,sigmaEtaJet,sigmaPhiJet,
                              ...
                              // lightJet1Px,lightJet1Py,lightJet1Pz,lightJet1E,
                              // sigmaPtJet,sigmaEtaJet,sigmaPhiJet,
                              sqrt(lightJet2Pt), 0.01, 0.01, mTop, sigmaMTop,
                              mW, sigmaMW);
        }

        if (leptonFlag == 1) {
            ev.addHadronicTop(bJet1Px, bJet1Py, bJet1Pz, bJet1E, sqrt(bJet1Pt),
                              sigmaEtaJet, sigmaPhiJet,
                              // sigmaPtJet,sigmaEtaJet,sigmaPhiJet,
                              // 0.000001, sigmaEtaJet,sigmaPhiJet,
                              lightJet1Px, lightJet1Py, lightJet1Pz, lightJet1E,
            ...
            ev.addLeptonicTop(bJet2Px, bJet2Py, bJet2Pz, bJet2E,
                              // sigmaPtJet,sigmaEtaJet,sigmaPhiJet,
                              sqrt(bJet2Pt), sigmaEtaJet, sigmaPhiJet, leptonPx,
                              leptonPy, leptonPz, leptonE, sigmaPtLep,
                              sigmaEtaLep, sigmaPhiLep, mTop, sigmaMTop, mW,
                              sigmaMW);
        }
        ...
        ev.getBestDeltas(bJetPtDeltas, bJetPhiDeltas, bJetEtaDeltas,
                         firstWDaughterPtDeltas, firstWDaughterPhiDeltas,
                         firstWDaughterEtaDeltas, secondWDaughterPtDeltas,
                         secondWDaughterPhiDeltas, secondWDaughterEtaDeltas,
                         WMassDeltas, topMassDeltas, lightJetPxDeltas,
                         lightJetPyDeltas);
        ...
        ev.getWDaughter1(0, W1Daughter1BestPx, W1Daughter1BestPy,
                         W1Daughter1BestPz, W1Daughter1BestE);
        ev.getWDaughter2(0, W1Daughter2BestPx, W1Daughter2BestPy,
                         W1Daughter2BestPz, W1Daughter2BestE);
        ...
        W1Daughter1Best.SetPxPyPzE(W1Daughter1BestPx, W1Daughter1BestPy,
                                   W1Daughter1BestPz, W1Daughter1BestE);
        XYZTLorentzVector W1Daughter2Best;
        W1Daughter2Best.SetPxPyPzE(W1Daughter2BestPx, W1Daughter2BestPy,
                                   W1Daughter2BestPz, W1Daughter2BestE);
        XYZTLorentzVector lightJet1Best;
        lightJet1BestPz = smearedLightParton1.Pz();
        lightJet1BestE =
            sqrt(smearedLightParton1.M2() + pow(lightJet1BestPx, 2) +
                 pow(lightJet1BestPy, 2) + pow(smearedLightParton1.Pz(), 2));
        lightJet1Best.SetPxPyPzE(lightJet1BestPx, lightJet1BestPy,
                                 lightJet1BestPz, lightJet1BestE);
        ...
        ev.getWDaughter1(1, W2Daughter1BestPx, W2Daughter1BestPy,
                         W2Daughter1BestPz, W2Daughter1BestE);
        ev.getWDaughter2(1, W2Daughter2BestPx, W2Daughter2BestPy,
                         W2Daughter2BestPz, W2Daughter2BestE);
        ...
        W2Daughter1Best.SetPxPyPzE(W2Daughter1BestPx, W2Daughter1BestPy,
                                   W2Daughter1BestPz, W2Daughter1BestE);
        XYZTLorentzVector W2Daughter2Best;
        W2Daughter2Best.SetPxPyPzE(W2Daughter2BestPx, W2Daughter2BestPy,
                                   W2Daughter2BestPz, W2Daughter2BestE);
        XYZTLorentzVector lightJet2Best;
        lightJet2BestPz = smearedLightParton2.Pz();
        lightJet2BestE =
            sqrt(smearedLightParton2.M2() + pow(lightJet2BestPx, 2) +
                 pow(lightJet2BestPy, 2) + pow(smearedLightParton2.Pz(), 2));
        lightJet2Best.SetPxPyPzE(lightJet2BestPx, lightJet2BestPy,
                                 lightJet2BestPz, lightJet2BestE);
        ...
        if (leptonFlag == 0) {
            W1Daughter1DeltaPtTrueSmeared =
                W1Daughter1TruePt - W1Daughter1SmearedPt;
            W1Daughter1DeltaRTrueSmeared =
                deltaR(antiLepton, smearedAntiLepton);
            ...
            W1Daughter2DeltaPtTrueSmeared =
                W1Daughter2TruePt - W1Daughter2SmearedPt;
            W1Daughter2DeltaRTrueSmeared =
                deltaR(qbarFromW, smearedLightQuark2);
        }
        ...
        bJet2DeltaRTrueSmeared =
            deltaR(antiBottomQuark, smearedAntiBottomQuark);
        if (leptonFlag == 0) {
            W2Daughter1DeltaPtTrueSmeared =
                W2Daughter1TruePt - W2Daughter1SmearedPt;
            W2Daughter1DeltaRTrueSmeared = deltaR(qFromW, smearedLightQuark1);
            W2Daughter2DeltaPtTrueSmeared =
                W2Daughter2TruePt - W2Daughter2SmearedPt;
        ...
        if (leptonFlag == 0) {
            W1Daughter1DeltaPtSmearedBest =
                W1Daughter1SmearedPt - W1Daughter1BestPt;
            W1Daughter1DeltaRSmearedBest =
                deltaR(smearedAntiLepton, W1Daughter1Best);
            ...
            W1Daughter1DeltaPtSmearedBest =
                W1Daughter1SmearedPt - W1Daughter1BestPt;
            W1Daughter1DeltaRSmearedBest =
                deltaR(smearedLightQuark1, W1Daughter1Best);
            W1Daughter2DeltaPtSmearedBest =
                W1Daughter2SmearedPt - W1Daughter2BestPt;
            W1Daughter2DeltaRSmearedBest =
                deltaR(smearedLightQuark2, W1Daughter2Best);
        }
        ...
        if (leptonFlag == 0) {
            W2Daughter1DeltaPtSmearedBest =
                W2Daughter1SmearedPt - W2Daughter1BestPt;
            W2Daughter1DeltaRSmearedBest =
                deltaR(smearedLightQuark1, W2Daughter1Best);
            W2Daughter2DeltaPtSmearedBest =
                W2Daughter2SmearedPt - W2Daughter2BestPt;
            W2Daughter2DeltaRSmearedBest =
                deltaR(smearedLightQuark2, W2Daughter2Best);
        } else if (leptonFlag == 1) {
            W2Daughter1DeltaPtSmearedBest =
                W2Daughter1SmearedPt - W2Daughter1BestPt;
            W2Daughter1DeltaRSmearedBest =
                deltaR(smearedLepton, W2Daughter1Best);
    ...
    leptonicBottomPtTS->SetMaximum(max(leptonicBottomPtTS->GetMaximum(),
                                       leptonicBottomPtTC->GetMaximum()) +
                                   1);
    ...
    leptonicTopPtTS->SetMaximum(
        max(leptonicTopPtTS->GetMaximum(), leptonicTopPtTC->GetMaximum()) + 1);
    ...
    leptonicWPtTS->SetMaximum(
        max(leptonicWPtTS->GetMaximum(), leptonicWPtTC->GetMaximum()) + 1);
    ...
    leptonPtTS->SetMaximum(
        max(leptonPtTS->GetMaximum(), leptonPtTC->GetMaximum()) + 1);
    ...
    neutrinoPtTS->SetMaximum(
        max(neutrinoPtTS->GetMaximum(), neutrinoPtTC->GetMaximum()) + 1);
    ...
    hadronicBottomPtTS->SetMaximum(max(hadronicBottomPtTS->GetMaximum(),
                                       hadronicBottomPtTC->GetMaximum()) +
                                   1);
    ...
    hadronicTopPtTS->SetMaximum(
        max(hadronicTopPtTS->GetMaximum(), hadronicTopPtTC->GetMaximum()) + 1);
    ...
    hadronicWPtTS->SetMaximum(
        max(hadronicWPtTS->GetMaximum(), hadronicWPtTC->GetMaximum()) + 1);
    ...
    hadronicQuarkPtTS->SetMaximum(
        max(hadronicQuarkPtTS->GetMaximum(), hadronicQuarkPtTC->GetMaximum()) +
        1);
    ...
    hadronicAntiQuarkPtTS->SetMaximum(max(hadronicAntiQuarkPtTS->GetMaximum(),
                                          hadronicAntiQuarkPtTC->GetMaximum()) +
                                      1);
    ...
    lightBottomPxTS->SetMaximum(
        max(lightBottomPxTS->GetMaximum(), lightBottomPxTC->GetMaximum()) + 1);
    ...
    lightAntiBottomPxTS->SetMaximum(max(lightAntiBottomPxTS->GetMaximum(),
                                        lightAntiBottomPxTC->GetMaximum()) +
                                    1);
